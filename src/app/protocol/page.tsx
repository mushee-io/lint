...
export default async function Protocol() {
  let status: Awaited<ReturnType<typeof getOpsStatus>> | null = null;
  try { status = await getOpsStatus(); } catch { status = null; }
  const cells = status ? [
